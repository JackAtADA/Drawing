...
if ( isset( $_GET["op"] ) && $_GET["op"] == "update"
	...
	$indexs = array("updateType", "drawingNo", "revisionNo", "date", "workOrder", "followUp", "typeName", "recordID", "fileLocation");
	$s_para = array();
	...
	$indexs = array("insertType", "drawingNo", "description", "revisionNo", "date", "typeName", "workOrder", "followUp", "fileLocation");
	$s_para = array();
